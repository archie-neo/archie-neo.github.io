...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.neoSearch = function () {
        var _this = this;
        var wikiUrl = "https://smarteconomy.wiki/api.php?origin=https://archie-neo.github.io";
        //var neonewsUrl = "https://neonewstoday.com/?s="+this.lastQuery; no API yet
        this.http.get(wikiUrl, {
            params: {
                ...
                srwhat: 'text',
                format: 'json',
                srsearch: this.lastQuery
            }
        }).subscribe(function (res) {
            _this.wikilist = res.json().query.search;
            if (_this.wikilist.length == 0)
                return _this.showResponse(_this.fetchUndefined());
            for (var _i = 0; _i < _this.wikilist.length; _i++) {
                var cleanText = _this.wikilist[_i].snippet.replace(/<\/?[^>]+(>|$)/g, "");
                _this.wikilist[_i].snippet = cleanText;
                _this.wikilist[_i].link = "https://smarteconomy.wiki/" + _this.wikilist[_i].title;
            }
            _this.wikiList.nativeElement.style.visibility = "visible";
            _this.showResponse("");
            _this.loaderHide();
        });
        return "";
    ...
    AppComponent.prototype.tokenDescription = function (responseData) {
        ...
        if (responseData.currency_type != null) {
            ...
            if (confidenceUnit < 0.75)
                return this.neoSearch();
        }
        else
            return this.neoSearch();
    ...
    AppComponent.prototype.loaderShow = function () {
        $('.loader').show();
    };
    ...
    AppComponent.prototype.resize_to_fit_NeoScan = function () {
        var fontsize = $('.neoscanBalances').css('font-size');
        $('.neoscanBalances').css('fontSize', parseFloat(fontsize) - 1);
        if ($('.neoscanBalances').height() >= $('.responseArea').height()) {
            this.resize_to_fit_NeoScan();
        }
    };
    ...
    AppComponent.prototype.processNeoScanAddress = function (address) {
        var _this = this;
        this.netWorth = 0;
        this.loaderShow();
        ...
        this.http.get(url, {
            ...
            _this.balances = res.json().balance;
            for (var _i = 0; _i < _this.balances.length; _i++) {
                var token = _this.balances[_i];
                if (token.amount == 0) {
                    _this.balances.splice(_i, 1);
                    _i = _i - 1;
                }
                else {
                    _this.balanceUsd(token);
                }
            }
            _this.showResponse("");
            _this.loaderHide();
            _this.neoscanBalances.nativeElement.style.visibility = "visible";
        }, function (err) {
            _this.showResponse("Address you entered is invalid. <br>Please correct it.");
            _this.loaderHide();
        });
    };
    AppComponent.prototype.balanceUsd = function (token) {
        var _this = this;
        var unit = token.asset;
        var amount = token.amount;
        var url = 'https://api.wit.ai/message';
        var question = unit;
        var tokenWit = "YE7TQH244HU7XFKGCLC2TGPQNBZ73UXU";
        this.http.get(url, {
            params: {
                q: question,
                access_token: tokenWit
            }
        }).subscribe(function (res) {
            _this.responseData = res.json().entities;
            var valueUnit, confidenceUnit;
            if (_this.responseData.currency_type != null) {
                valueUnit = _this.responseData.currency_type[0].value;
                confidenceUnit = _this.responseData.currency_type[0].confidence;
                var url = 'https://min-api.cryptocompare.com/data/price';
                _this.http.get(url, {
                    params: {
                        fsym: valueUnit,
                    ...
                    var price = res.json().USD;
                    var priceTotal = token.amount * price;
                    if (priceTotal.toString() === "NaN" || priceTotal == 0) {
                        token.usd = "";
                    }
                    else {
                        token.usd = "($ " + priceTotal.toFixed(2) + ")";
                        _this.netWorth = _this.netWorth + priceTotal;
                    }
                });
                return;
            }
    ...
    AppComponent.prototype.processNeoScanTransaction = function (tx) {
        $('.responseAreaText').css('fontSize', 60);
        this.showResponse("This is transaction. <br> Detailed preview coming soon.");
    };
    AppComponent.prototype.determineQueryType = function (question) {
        if (question === "")
            return;
        else if (question === "AbiRBgNjHd3xvxQpQjHEugVynHLjZdW4Pl") {
            $('.responseAreaText').css('fontSize', 60);
            this.showResponse("Just Do It.");
            return 1;
        }
        else if (question.length == 34 && question.indexOf(' ') == -1 && question.indexOf('A') == 0) {
            this.processNeoScanAddress(question);
            return 1;
        }
        else if (question.length == 64 && question.indexOf(' ') == -1) {
            this.processNeoScanTransaction(question);
            return 1;
        }
        return 0;
    };
    AppComponent.prototype.doPOST = function (query) {
        ...
        if (this.determineQueryType(question))
            return;
        $('.loader').show();
        this.http.get(url, {
            params: {
    ...
    AppComponent.prototype.onKeydown = function (event) {
        if (event.key === "Enter") {
            ...
            this.balances = null;
            this.neoscanBalances.nativeElement.style.visibility = "hidden";
            this.wikiList.nativeElement.style.visibility = "hidden";
            if ($('.textArea').val() !== "") {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('neoscanBalances'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AppComponent.prototype, "neoscanBalances", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('wikiList'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AppComponent.prototype, "wikiList", void 0);
